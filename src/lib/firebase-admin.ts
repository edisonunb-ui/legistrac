...
/**
 * Inicializa o Firebase Admin SDK usando as credenciais fornecidas pelo usuário.
 */
function getAdminApp() {
  ...
  // Chave privada fornecida pelo usuário no chat para ativar o provisionamento
