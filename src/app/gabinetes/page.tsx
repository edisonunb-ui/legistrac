...
import { LayoutDashboard, Plus, Trash2, Loader2, Building2, ShieldCheck } from "lucide-react";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        <header className="mb-8">
          ...
          <p className="text-muted-foreground">Crie instâncias isoladas para cada um dos 13 vereadores.</p>
        </header>
            ...
            <CardContent>
              <form onSubmit={handleAdd} className="space-y-4">
                ...
                <Button className="w-full font-bold" type="submit" disabled={adding}>
                  {adding ? <Loader2 className="animate-spin" /> : <><Plus className="mr-2" size={18} /> Criar Gabinete Isolado</>}
                </Button>
              </form>
            </CardContent>
          </Card>
