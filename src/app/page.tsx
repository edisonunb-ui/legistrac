...
export default function StrategicDashboard() {
  ...
  if (authLoading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-background gap-4">
        ...
        <p className="text-primary text-sm font-bold uppercase tracking-widest animate-pulse">Iniciando Gabinete...</p>
      </div>
    );
  }
  ...
  if (loadingProfile) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-background gap-4">
        <Loader2 className="animate-spin text-primary h-10 w-10" />
        <p className="text-primary text-sm font-bold uppercase tracking-widest animate-pulse">Sincronizando Dados...</p>
      </div>
    );
  }
      ...
      <main className="container mx-auto px-4 py-6 md:py-10">
        <header className="mb-8 md:mb-12">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div>
              <h1 className="text-3xl md:text-5xl font-black tracking-tighter">Legis<span className="text-cabinet-gradient">Trac</span></h1>
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <Link href="/demandas/new" className="w-full sm:w-auto">
                <Button variant="outline" className="w-full border-primary/20 h-11 hover:bg-primary/10 hover:text-primary font-bold">Nova Demanda</Button>
              </Link>
              <Link href="/liderancas/new" className="w-full sm:w-auto">
                <Button className="w-full bg-cabinet-gradient text-white border-none font-black h-11 shadow-lg shadow-primary/20 hover:scale-105 transition-transform">
                  Cadastrar Líder
                </Button>
              </Link>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-10">
          <Card className="bg-card border-primary/10 shadow-lg relative overflow-hidden group">
            <div className="absolute top-0 right-0 p-2 opacity-5 group-hover:opacity-20 transition-opacity">
               <Target size={60} className="text-primary" />
            </div>
            <CardContent className="pt-6">
              <p className="text-[10px] font-bold uppercase text-primary mb-1 tracking-widest">Votos Mapeados</p>
              ...
              <div className="mt-4">
                ...
                <Progress value={stats.progressoMeta} className="h-2 bg-primary/10" />
              </div>
            </CardContent>
          </Card>

          <Card className="bg-card border-primary/10 shadow-lg group">
            <CardContent className="pt-6">
              <div className="flex justify-between items-start">
                <div>
                  <p className="text-[10px] font-bold uppercase text-primary mb-1 tracking-widest">Base de Líderes</p>
              ...
              <p className="text-[10px] text-primary/80 mt-4 font-bold uppercase tracking-widest flex items-center gap-1">
          ...
          <Card className="bg-card border-primary/10 shadow-lg group">
            <CardContent className="pt-6">
              <div className="flex justify-between items-start">
                <div>
                  <p className="text-[10px] font-bold uppercase text-primary mb-1 tracking-widest">Processos Ativos</p>
          ...
          <Card className="bg-card border-primary/10 shadow-lg group">
            <CardContent className="pt-6">
              <div className="flex justify-between items-start">
                <div>
                  <p className="text-[10px] font-bold uppercase text-primary mb-1 tracking-widest">Meta Estratégica</p>
                  ...
                  {(profile?.perfil === "ADMIN" || isSuperAdmin) && (
                    <Dialog open={isEditingMeta} onOpenChange={setIsEditingMeta}>
                      <DialogTrigger asChild>
                        <button className="mt-2 text-[10px] flex items-center gap-1 hover:underline text-primary font-bold uppercase tracking-tighter">
                          <Edit2 size={10} /> Ajustar
                        </button>
                      </DialogTrigger>
                      <DialogContent className="sm:max-w-md bg-card border-primary/20">
                        <DialogHeader><DialogTitle className="text-primary font-black">Meta Eleitoral 2026</DialogTitle></DialogHeader>
                        ...
                        <DialogFooter>
                          <Button className="w-full h-11 font-black bg-cabinet-gradient text-white border-none" onClick={handleUpdateMeta}>Salvar Objetivo</Button>
                        </DialogFooter>
                      </DialogContent>
                    </Dialog>
                  )}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <section className="lg:col-span-2">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-black flex items-center gap-2">
                <Sparkles className="text-primary" size={20} /> Lideranças Recentes
              </h2>
              <Link href="/liderancas" className="text-[10px] font-black text-primary hover:underline tracking-widest">VER MAPA COMPLETO</Link>
            </div>
            <div className="space-y-3">
              {allLeaders.length === 0 ? (
                <div className="text-center py-16 bg-card rounded-2xl border border-dashed border-primary/10">
                  <Users size={40} className="mx-auto text-primary opacity-10 mb-4" />
                    ...
                    <Card className="border-none shadow-sm hover:bg-primary/5 transition-colors mb-3 group">
                      <CardContent className="p-4 flex items-center justify-between">
                        <div className="flex items-center gap-4">
                          <div className="w-10 h-10 bg-cabinet-gradient rounded-full flex items-center justify-center font-black text-white text-sm shadow-md">
                          ...
                          <div>
                            ...
                            <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-[10px] text-muted-foreground mt-1 font-bold uppercase">
                              <span className="flex items-center gap-1"><MapPin size={10} className="text-primary" /> {l.bairro}</span>
          ...
          <aside className="space-y-6">
            <Card className="bg-cabinet-gradient text-white border-none shadow-xl shadow-primary/10 overflow-hidden relative">
              ...
              <CardContent className="relative z-10">
                <p className="text-sm opacity-90 font-bold italic leading-relaxed">"Cada atendimento registrado é uma semente plantada para a base."</p>
            ...
            <Card className="bg-card border-primary/10 shadow-lg">
              <CardHeader><CardTitle className="text-[10px] font-black uppercase tracking-widest text-primary">Resumo do Gabinete</CardTitle></CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between p-3 bg-primary/5 rounded-lg border border-primary/10">
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-cabinet-gradient rounded-full" />
